...
@PartitionMapper(name = "Trips")
@Documentation("TODO fill the documentation for this mapper")
public class TripsMapper implements Serializable {
    ...
    public TripsMapper(@Option("configuration") final TripsMapperConfiguration configuration,
    ...
    @Split
    public List<TripsMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 TripsMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public TripsSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new TripsSource(configuration, service, jsonBuilderFactory, restClient);
    }
}