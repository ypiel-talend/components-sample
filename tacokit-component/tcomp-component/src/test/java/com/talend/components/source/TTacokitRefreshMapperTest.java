...
public class TTacokitRefreshMapperTest {
    ...
    public void produce() throws IOException {
        ...
        final TTacokitRefreshMapperConfiguration configuration =  new TTacokitRefreshMapperConfiguration()
                                                                            /* .setMonitored_file()
                                                                               .setTimes() */;

        // We create the component mapper instance using the configuration filled above
        final Mapper mapper = COMPONENT_FACTORY.createMapper(TTacokitRefreshMapper.class, configuration);
