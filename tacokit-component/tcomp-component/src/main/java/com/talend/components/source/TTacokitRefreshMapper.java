...
@Icon(value = Icon.IconType.CUSTOM, custom = "tacokit_refresh_icon32.png") // you can use a custom one using @Icon(value=CUSTOM, custom="filename") and adding icons/filename_icon32.png in resources
@PartitionMapper(name = "tTacokitRefresh")
@Documentation("TODO fill the documentation for this mapper")
public class TTacokitRefreshMapper implements Serializable {
    private final TTacokitRefreshMapperConfiguration configuration;
    private final Tcomp_componentService service;
    private final JsonBuilderFactory jsonBuilderFactory;

    public TTacokitRefreshMapper(@Option("configuration") final TTacokitRefreshMapperConfiguration configuration,
    ...
    @Split
    public List<TTacokitRefreshMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 TTacokitRefreshMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public TTacokitRefreshSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new TTacokitRefreshSource(configuration, service, jsonBuilderFactory);
    }
}