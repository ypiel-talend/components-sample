...
@PartitionMapper(name = "ServiceNow")
public class ServiceNowMapper implements Serializable {

    private final ServiceNowDataSet configuration;
    private final ServiceNowClient service;

    public ServiceNowMapper(@Option("configuration") final ServiceNowDataSet configuration, final ServiceNowClient service) {
    ...
    @Split
    public List<ServiceNowMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 ServiceNowMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public ServiceNowSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new ServiceNowSource(configuration, service);
    }
}