...
public class ServiceNowMapperTest {
    ...
    public void produce() throws IOException {
        ...
        final ServiceNowDataSet configuration =  new ServiceNowDataSet()
                                                                            /* .setTable()
                                                                               .setUsername()
                                                                               .setUrl()
                                                                               .setPassword() */;
        ...
        final Mapper mapper = COMPONENT_FACTORY.createMapper(ServiceNowMapper.class, configuration);

        // Collect the source as a list
        assertEquals(asList(/* TODO - give the expected data */), COMPONENT_FACTORY.collectAsList(ServiceNowRecord.class, mapper));
    }
